    ...
    return (
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">Mettez à jour vos informations personnelles et votre adresse email.</p>
            </header>
            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                ...
                {mustVerifyEmail && user.email_verified_at === null && (
                    <div>
                        ...
                        {status === 'verification-link-sent' && <div className="mt-2 text-sm font-medium text-green-600">Un nouveau lien de vérification a été envoyé.</div>}
                    </div>
                )}
