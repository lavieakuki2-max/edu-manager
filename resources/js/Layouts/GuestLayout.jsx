    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white">
            <div className="grid min-h-screen lg:grid-cols-[1.05fr_.95fr]">
                <aside className="relative hidden overflow-hidden bg-gradient-to-br from-teal-600 via-teal-700 to-cyan-800 p-12 lg:flex lg:flex-col lg:justify-between">
                    ...
                    <Link href="/" className="relative flex items-center gap-3 text-xl font-bold">
                        <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white text-teal-700">
                            <GraduationCap size={24} />
                        </span>
                        EduManager
                    </Link>
                    <div className="relative max-w-lg">
                        <p className="mb-5 text-sm font-semibold uppercase tracking-[.22em] text-teal-200">Plateforme academique — UNILUK</p>
                    ...
                    <div className="relative flex items-center gap-3 text-sm text-teal-200">
